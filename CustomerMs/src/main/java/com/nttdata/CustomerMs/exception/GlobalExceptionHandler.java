...
import com.nttdata.CustomerMs.model.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CustomExceptions.DniAlreadyExistsException.class)
    public ResponseEntity<ErrorResponse> handleDniAlreadyExistsException(CustomExceptions.DniAlreadyExistsException ex) {
        ErrorResponse errorResponse = new ErrorResponse();
        errorResponse.setCode(HttpStatus.CONFLICT.value());
        errorResponse.setMessage("Conflicto de datos");
        errorResponse.setDetails(ex.getMessage());
